...
Define how Hephaestus images reach Docker Hub: guarded semver release images from `main` tags and disposable development images from the integration branch.
